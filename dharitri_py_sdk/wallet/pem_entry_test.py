...
def test_from_text_all():
    ...
    assert entry.label == "drt18y0exfc84806smfmeweat5xvnuj66rngpljfnug8mpzt0eh2w82sc0eqzh"
    assert entry.message[0:USER_SEED_LENGTH].hex() == "2bbcdae7e193924fa0d301e7a12c7defc92a93bc5e587cc968f04fcb86022e1c"
...
def test_from_text_all_for_validators():
    ...
    assert entry.message.hex() == "132e9b47291fcc62c64b334fd434ab2db74bf64b42d4cc1b4cedd10df77c1936"
    ...
    assert entry.message.hex() == "490a55ab40cbea7798f7a743bcd3da44276bec6ad083759a4516646186257466"
    ...
    assert entry.message.hex() == "59074392f4f970c3b5d4ba1783955fcf9fcc44d9a5aff2b5cddb0020ca155b5c"
    ...
    assert entry.message.hex() == "a6091fb517645196396d04aab3679e4f059db9d85c981625c1999dada985cd5e"
