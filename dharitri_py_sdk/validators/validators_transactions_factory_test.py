...
class TestValidatorsTransactionsFactory:
    ...
    def test_create_transaction_for_new_delegation_contract_from_validator(self):
    ...
    def test_create_transaction_for_merging_validator_to_delegation_whitelist(self):
