...
class TestDelegationTransactionsOutcomeParser:
    ...
    def test_parse_create_new_delegation_contract(self):
        ...
        sc_deploy_event = TransactionEvent(
            raw={},
            address=Address.new_from_bech32("drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqy8lllls8knyn2"),
            identifier="SCDeploy",
            topics=base64_topics_to_bytes(encodedTopics),
            data=b"",
            additional_data=[],
        ...
        sc_result = SmartContractResult(
            raw={},
            sender=Address.new_from_bech32("drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqylllsz8he8y"),
